...
#ifndef INC_ADS131M04_H_
#define INC_ADS131M04_H_

// ----------- FZ stole from Arduino ADS131M04 library & ads131m04-stm32-driver ----------------
...
#define ADS131M04_OPCODE_NULL ((uint16_t)0x0000)
#define ADS131M04_OPCODE_RESET ((uint16_t)0x0011)
#define ADS131M04_OPCODE_RREG ((uint16_t)0xA000)
#define ADS131M04_OPCODE_WREG ((uint16_t)0x6000)
#define ADS131M04_OPCODE_STANDBY ((uint16_t)0x0022)
#define ADS131M04_OPCODE_WAKEUP ((uint16_t)0x0033)
...
#define ADS131M04_WORD_LENGTH_24BIT
//#define ADS131M04_WORD_LENGTH_32BIT_SIGN_EXTEND
//#define ADS131M04_WORD_LENGTH_32BIT_ZERO_PADDED
...
extern bool ADS131M04_isResetStatus(void);
extern bool ADS131M04_isLockSPI(void);
extern bool ADS131M04_setDrdyFormat(uint8_t drdyFormat);
extern bool ADS131M04_setDrdyStateWhenUnavailable(uint8_t drdyState);
extern bool ADS131M04_setPowerMode(uint8_t powerMode);
extern bool ADS131M04_setChannelEnable(uint8_t channel, uint16_t enable);
extern bool ADS131M04_setChannelPGA(uint8_t channel, uint16_t pga);
extern void ADS131M04_setGlobalChop(uint16_t global_chop);
extern void ADS131M04_setGlobalChopDelay(uint16_t delay);
extern bool ADS131M04_setInputChannelSelection(uint8_t channel, uint8_t input);
