...
#define UWB_RST_GPIO_Port GPIOA
#define LORA_IRQ_Pin GPIO_PIN_4
#define LORA_IRQ_GPIO_Port GPIOA
#define LORA_IRQ_EXTI_IRQn EXTI4_IRQn
#define PIN_LED2_Pin GPIO_PIN_4
#define PIN_LED2_GPIO_Port GPIOC
#define PIN_LED1_Pin GPIO_PIN_0
#define PIN_LED1_GPIO_Port GPIOB
#define SD_CS_Pin GPIO_PIN_6
#define SD_CS_GPIO_Port GPIOC
#define LORA_CS_Pin GPIO_PIN_7
#define LORA_CS_GPIO_Port GPIOC
#define LORA_PWR_EN_Pin GPIO_PIN_8
#define LORA_PWR_EN_GPIO_Port GPIOC
